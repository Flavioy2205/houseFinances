...
import { LayoutDashboard, PlusCircle, MessageSquare, ReceiptText, Wallet, LogOut, Database, ShieldAlert, CalendarClock, CalendarDays } from 'lucide-react';
...
export const Sidebar = ({ activeTab, setActiveTab }) => {
  ...
  const menuItems = [
    ...
    { id: 'calendario', label: 'Calendário de Contas', icon: CalendarDays },
